...
{
        public static final Logger LOG = LoggerFactory.getLogger(CyclicBarrierExample2.class);
        
        private final static int threadCount = 2;
        
        //private static CyclicBarrier barrier = new CyclicBarrier(2, ()-> {LOG.info("callback is running");}); //同步等待
