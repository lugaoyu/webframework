...
{
        public static final Logger LOG = LoggerFactory.getLogger(ConcurrentSkipListSetExample.class);
        
        public static final int clientThread = 5000;
        
        public static final int threadThread = 200;
        
        public static Set<Integer> list  = new ConcurrentSkipListSet<Integer>();
